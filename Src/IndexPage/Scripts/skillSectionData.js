export default [
	...
	},
	{
        ...
        paragraph1: `C# was the language I learned to program with, and I know many of the features of the language.
            ...
            Now I build websites and web api's using C# and ASP.net Core web framework. If a database is needed
            for a website, I use Entity Framework Core's code first approach to generate the SQL queries and database tables. `, 
        paragraph2: `In addition to ASP.net Core I use a few extra libraries to make the web application better.
            ...
            Vue instead of or in addition to ASP.net Core's Razor Pages.`, 
		images: [
			{
